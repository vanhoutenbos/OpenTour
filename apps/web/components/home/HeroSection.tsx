...
export function HeroSection({ locale, isLoggedIn }: Props) {
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-surface via-surface-2 to-green-950" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 w-full">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-content leading-tight mb-6">
            Organiseer golf toernooien<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-300">
              zonder poespas.
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-content-muted mb-4 max-w-2xl leading-relaxed">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-8 text-sm text-content-muted">
            <span className="flex items-center gap-1.5">
              <svg className="w-4 h-4 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
              Geen account nodig voor scores bekijken
            </span>
            <span className="hidden sm:inline text-content-secondary">·</span>
            <span className="flex items-center gap-1.5">
              <svg className="w-4 h-4 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
